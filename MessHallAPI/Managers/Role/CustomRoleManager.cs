...
namespace MessHallAPI.Managers.Role
{
    public static class CustomRoleManager
    {
        ...
        // The role the local client has been assigned
    ...
    public interface ICustomRole
    {
        ...
        void OnEmergencyMeetingCalled(Il2CppFusion.PlayerRef sourcePlayer, Il2CppFusion.NetworkBool forceVote) { }
        void OnBodyCalled(int foundPlayer, Il2CppFusion.PlayerRef sourcePlayer, Il2CppFusion.NetworkBool forceVote) { }
        void OnPlayerWasKilled(Il2CppFusion.PlayerRef victim, Il2CppFusion.PlayerRef killer, bool vigiKill, bool selfKill) { }
